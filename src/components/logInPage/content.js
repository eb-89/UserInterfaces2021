...
export default class Content {
  ...
  createLoginForm = () => {
    ...
    let btn_login = $('<input id="login-btn" type="submit" value="Sign in"/>');
    ...
    let label_username = $('<label class="label" for="Username">Username</label><br>');
    let input_username = $('<input class="input-txt" type="text" name="username" id="Username" required><br>');
    let msg_username = $('<div class="txt-hide">The username you entered is incorrect</div>');

    $(cont_username).append(label_username);
    $(cont_username).append(input_username);
    $(cont_username).append(msg_username);

    let label_password = $('<label class="label" for="Password">Password</label><br>');
    let input_password = $('<input class="input-txt" type="password" name="password" id="Password" required><br>');
    let msg_password = $('<div class="txt-hide">The password you entered is incorrect</div>');
